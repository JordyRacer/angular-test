...
describe('Observable.prototype.zip', function () {
    ...
    type('should support rest parameter observables', function () {
        /* tslint:disable:no-unused-variable */
        var o;
        var z;
        var a = o.zip.apply(o, z);
        /* tslint:enable:no-unused-variable */
    });
    type('should support projected rest parameter observables', function () {
        /* tslint:disable:no-unused-variable */
        var o;
        var z;
        var a = o.zip.apply(o, z.concat([function () {
            var r = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                r[_i - 0] = arguments[_i];
            }
            return r.map(function (v) { return v.toString(); });
        }]));
        /* tslint:enable:no-unused-variable */
    });
    type('should support projected arrays of observables', function () {
        /* tslint:disable:no-unused-variable */
        var o;
        var z;
        var a = o.zip(z, function () {
            var r = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                r[_i - 0] = arguments[_i];
            }
